...
type LayoutRouteId = RouteId | "/my/settings" | "/my/settings/account" | "/my/settings/profile" | "/my/settings/security"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/my/settings/+page.server.js').load>>>>>>;
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/my/settings/+layout.server.js').load>>>>>>;
